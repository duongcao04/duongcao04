...
export default function HeroSection() {
    ...
    return (
        <div className="2xl:flex flex-col items-center justify-start">
            <div className="space-y-6">
                <div className="flex flex-col items-start 2xl:flex-row 2xl:items-center justify-start gap-5">
                    ...
                    <div className="flex items-center justify-start gap-6">
                        ...
                        />
                        <MotionH1 className="text-5xl tablet:text-7xl font-lexendDeca font-bold bg-linear-to-r from-primary-600 via-orange-600 to-orange-500 text-transparent bg-clip-text tracking-wider">
                            Duong Cao!
                        </MotionH1>
                    </div>
                </div>
            ...
            <div className="mt-6 2xl:mt-10 max-w-225">
